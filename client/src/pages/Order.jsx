            ...
            <div className="pt-6 flex flex-row  ">
              <ul className="flex gap-1">
                <li className="mr-2">
                  <a
                    ...
                    className="inline-block w-[38px] h-[38px] text-center leading-[38px] rounded-[50%] bg-gray-200 text-gray-400 text-xs"
                  >
                    S
                  </a>
                </li>
                ...
                <li>
                  <a className="inline-block w-[38px] h-[38px] text-center leading-[38px] rounded-[50%] bg-gray-200 text-gray-400 text-xs ">
                    XXL
                  </a>
                </li>
              </ul>
              <div class="custom-number-input w-24 ml-10">
                <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent border">
                  <button class=" bg-gray-200 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-l cursor-pointer outline-none">
                  ...
                  <input
                    ...
                    value="0"
                  ></input>
                  <button class="bg-gray-200 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-r cursor-pointer">
                    <span class="m-auto text-2xl font-thin">+</span>
                  </button>
                </div>
              </div>
